...
class SpecialController < ApplicationController
  ...
  def index
    ...
    User.create(email: 'bryalara@tamu.edu', role: 1, firstName: 'VWB', lastName: 'TAMU', phoneNumber: 1_231_231_234, classification: 'Senior',
                tShirtSize: 'M', optInEmail: true, participationPoints: 0, approved: true)
